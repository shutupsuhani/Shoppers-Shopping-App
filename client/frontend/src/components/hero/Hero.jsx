...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col m-auto px-4 md:flex-row justify-center bg-pink-50 items-center h-auto md:h-96 p-4 md:p-0">
      ...
      <p className="mt-4 text-xl font-semibold md:text-xl mb-5 font-serif text-pink-900 ">50% off super sale </p>
        ...
        <button id="explore-btn" className="border-2 border-white mt-4 px-4 py-2 font-serif text-black bg-white hover:bg-black hover:text-white transition duration-300">
          Explore Now
        </button>
