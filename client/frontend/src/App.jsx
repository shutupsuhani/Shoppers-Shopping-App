...
const NotFound = () => {
  return (
    ...
    <div className="container mx-auto my-8">
      ...
      <Link to='/home'><button className="w-48 h-14 bg-gradient-to-r  from-yellow-600 to-orange-600 border-2 text-white border-black hover:border-white font-semibold mt-4 mx-auto flex flex-col items-center justify-center">
           Return To Home Page
          </button></Link>
    </div>
