  ...
  return (
    <footer className="bg-slate-800 w-full sm:full md:full lg:full px-4 text-white py-8">
        ...
        <div className="col-span-1">
          ...
          <div className="relative">
            <input
              ...
              className="p-2 w-full z-0 rounded mb-2 bg-black focus:outline-none text-white border-2 border-white pl-12"
            />
            <img
              src="/assets/send3.png" // Adjust the path to your image
              alt="Send"
      ...
      <div className="text-center mt-8 text-gray-400">
        <p>© Shoppers 2024, All rights reserved</p>
      </div>
    </footer>
  );
};
